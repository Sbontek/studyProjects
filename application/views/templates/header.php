<html>
		...
		<div class ="container">
			...
			<?php if($this->session->flashdata('category_created')): ?>
				<?php echo '<p class="alert alert-succes">'.$this->session->flashdata('category_created').'</p>' ;?>			
			<?php endif; ?>
			...
			<?php if($this->session->flashdata('post_updated')): ?>
				<?php echo '<p class="alert alert-succes">'.$this->session->flashdata('post_updated').'</p>' ;?>			
			<?php endif; ?>
